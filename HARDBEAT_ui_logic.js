/* ==========================================
   HARDBEAT PRO - UI LOGIC (CONNECTED TO CORE)
   ========================================== */
...
// NOTE : On ne redéclare PAS drumSequences, kickSettings etc. 
// Ils existent déjà dans window grace à core_audio.js
...
window.addEventListener('load', () => {
    ...
    console.log("UI Logic : Prêt (Safe Shared State).");
});
