/* ==========================================
   HARDBEAT PRO - AUDIO ENGINE (PURE)
   ========================================== */
...
// --- PARAMETRES SONORES (Mais pas les séquences !) ---
let isPlaying = false;
let globalAccentBoost = 1.4;

// Paramètres Instruments (Valeurs par défaut)
...
console.log("AUDIO ENGINE V2: Clean & Ready.");
