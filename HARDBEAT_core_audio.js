/* ==========================================
   HARDBEAT PRO - CORE AUDIO (PASSIVE ENGINE)
   ========================================== */
...
// --- PLAYBACK (Reçoit TOUS les paramètres depuis l'UI) ---
...
// C'EST ICI QUE LE FIX SYNTH SE FAIT : On reçoit params depuis l'UI
window.playSynthNote = function(freq, volume, seqId, params) {
    if (!freq || freq < 20) return;
    
    // Routage vers le bon effet
    ...
    // Application des paramètres reçus de l'UI
    filter.type = 'lowpass';
